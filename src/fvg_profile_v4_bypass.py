...
def build_report(all_coin_data, results_data):
    ...
    L("**BYPASS:** is_high_quality_fvg / is_fvg_valid / should_trade devre disi — A/B karsilastirma icin")
...
def main():
    ...
    parquet_path = os.path.join(os.path.dirname(__file__), "..", "reports", "trades_multi_session_bypass.parquet")
    global _LOGGER
