...
- **KOŞU BEKLENİYOR:** kullanıcı `python src\analyzer_v5.py --workers 6 --trail-exp PARTIAL_TP_1_5R` koşacak (28 sembol). Sonuç gelince baseline + 4 PP + HTF_BIAS_ALIGN tablosuyla karşılaştırılıp LUNA raporu yazılacak.
