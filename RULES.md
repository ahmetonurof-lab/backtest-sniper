...
2. **jcodemunch + index.json** — Kod değişikliğinden ÖNCE `index.json`'u oku (aynı klasörde). İçinde 262 fonksiyonun dosya ve satır numarası var. jcodemunch ile bul, index.json ile teyit et. jcodemunch navigasyon aracıdır, kod temizleme/değiştirme aracı değildir.
